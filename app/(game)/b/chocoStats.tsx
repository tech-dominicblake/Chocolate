                                    ...
                                    <View style={styles.challengeItems}>
                                        <View style={styles.player1Container}>
                                            <TouchableOpacity
                                                ...
                                                disabled={consumedChocoInB.includes(challenge.number) || currentTurn === 'him' || round === 3}
                                            ...
                                            >
                                                ...
                                                <Image
                                                    ...
                                                    resizeMode="contain"
                                                />
                                                {herchoco === challenge.number && round !== 3 && <View style={styles.herAvatarContainer}>
                                        ...
                                        <View style={styles.player2Container}>
                                            <TouchableOpacity
                                                ...
                                                activeOpacity={0.7}
                                                onPress={() => handleChocolatePress(challenge.number + 12)}
                                                disabled={consumedChocoInB.includes(challenge.number + 12) || currentTurn === 'her' || round === 3}
                                            >
                                                {consumedChocoInB.includes(challenge.number + 12) &&
                                                    <View style={styles.consumeTickContainer}>
                                                ...
                                                <Image
                                                    ...
                                                    resizeMode="contain"
                                                />
                                                {himchoco === challenge.number + 12 && round !== 3 && <View style={styles.himAvatarContainer}>
                                                    <View style={[styles.speechBubble, { backgroundColor: isDark ? '#3C4047' : '#FFFFFF' }]}>
                                                        <Image
